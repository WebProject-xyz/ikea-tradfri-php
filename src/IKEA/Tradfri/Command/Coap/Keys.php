...
class Keys
{
    ...
    const ATTR_DEVICE_INFO_TYPE_DRIVER_10W = 'TRADFRI Driver 10W';
    const ATTR_DEVICE_INFO_TYPE_DRIVER_30W = 'TRADFRI Driver 30W';
    const ATTR_DEVICE_INFO_TYPE_BLUB = 'TRADFRI bulb';
    ...
    const ATTR_DEVICE_INFO_TYPE_BLUB_E14_W = 'TRADFRI bulb E14 W op/ch 400lm';
