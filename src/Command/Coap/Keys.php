...
final class Keys
{
    ...
    final public const ROOT_NOTIFICATION                           = '15006';  // speculative name
    final public const ROOT_REMOTE_CONTROL                         = '15009';
    final public const ROOT_SIGNAL_REPEATER                        = '15014';
    final public const ROOT_SMART_TASKS                            = '15010';
    final public const ROOT_START_ACTION                           = '15013';  // found under ATTR_START_ACTION
    final public const ATTR_START_BLINDS                           = '15015';
    final public const ROOT_AIR_PURIFIER                           = '15025';
    ...
    final public const ATTR_APPLICATION_TYPE_BLIND                 = 7;
    final public const ATTR_BLIND_CURRENT_POSITION                 = '5536';
    final public const ATTR_BLIND_TRIGGER                          = '5523';
    final public const ATTR_AIR_PURIFIER_MODE                      = '5900';
    final public const ATTR_AIR_PURIFIER_FILTER_RUNTIME            = '5902';
    final public const ATTR_AIR_PURIFIER_FILTER_STATUS             = '5903';
    final public const ATTR_AIR_PURIFIER_FILTER_LIFETIME_TOTAL     = '5904';
    final public const ATTR_AIR_PURIFIER_CONTROLS_LOCKED           = '5905';
    final public const ATTR_AIR_PURIFIER_LEDS_OFF                  = '5906';
    final public const ATTR_AIR_PURIFIER_AIR_QUALITY               = '5907';
    final public const ATTR_AIR_PURIFIER_FAN_SPEED                 = '5908';
    final public const ATTR_AIR_PURIFIER_MOTOR_RUNTIME_TOTAL       = '5909';
    final public const ATTR_AIR_PURIFIER_FILTER_LIFETIME_REMAINING = '5910';
    final public const ATTR_AIR_PURIFIER_MODE_AUTO                 = 1;
    ...
    final public const ATTR_GATEWAY_ID_2                           = '9100';  // stored in IKEA app code as gateway id
    final public const ATTR_GATEWAY_TIME_SOURCE                    = '9071';
    final public const ATTR_GATEWAY_UPDATE_PROGRESS                = '9055';
    final public const ATTR_GROUP_MEMBERS                          = '9018';
    final public const ATTR_GROUP_ID                               = '9038';
    ...
    final public const ATTR_LIGHT_CONTROL                          = '3311';  // array
    final public const ATTR_MASTER_TOKEN_TAG                       = '9036';
    final public const ATTR_MOOD                                   = '9039';
    final public const ATTR_NAME                                   = '9001';
    final public const ATTR_NTP                                    = '9023';
    final public const ATTR_FIRMWARE_VERSION                       = '9029';
    final public const ATTR_FIRST_SETUP                            = '9069';  // ??? unix epoch value when gateway first setup
    final public const ATTR_GATEWAY_INFO                           = '15012';
    final public const ATTR_GATEWAY_ID                             = '9081';  // ??? id of the gateway
    final public const ATTR_GATEWAY_REBOOT                         = '9030';  // gw reboot
    final public const ATTR_GATEWAY_FACTORY_DEFAULTS               = '9031';  // gw to factory defaults
    final public const ATTR_GATEWAY_FACTORY_DEFAULTS_MIN_MAX_MSR   = '5605';
    final public const ATTR_GOOGLE_HOME_PAIR_STATUS                = '9105';
    final public const ATTR_DEVICE_STATE                           = '5850';  // 0 / 1
    final public const ATTR_LIGHT_DIMMER                           = '5851';  // Dimmer, not following spec: 0..255
    final public const ATTR_LIGHT_COLOR_HEX                        = '5706';  // string representing a value in hex
    ...
    final public const ATTR_START_ACTION                           = '9042';  // array
    final public const ATTR_SMART_TASK_TYPE                        = [
    ...
    final public const ATTR_TIME_END_TIME_HOUR                 = '9048';
    final public const ATTR_TIME_END_TIME_MINUTE               = '9049';
    final public const ATTR_TIME_START_TIME_HOUR               = '9046';
    final public const ATTR_TIME_START_TIME_MINUTE             = '9047';
    ...
    final public const URL_OTA_FW = 'https://fw.ota.homesmart.ikea.net/feed/version_info.json';
    ...
    final public const ATTR_DEVICE_MANUFACTURER     = '0';
    final public const ATTR_DEVICE_MODEL_NUMBER     = '1';
    final public const ATTR_DEVICE_SERIAL           = '2';
    final public const ATTR_DEVICE_FIRMWARE_VERSION = '3';
    final public const ATTR_DEVICE_POWER_SOURCE     = '6';
    final public const ATTR_DEVICE_BATTERY          = '9';
    ...
    final public const ATTR_DEVICE_INFO_TYPE_MOTION_SENSOR                  = 'TRADFRI motion sensor';
    final public const ATTR_DEVICE_INFO_TYPE_CONTROL_OUTLET                 = 'TRADFRI control outlet';
    final public const ATTR_DEVICE_INFO_TYPE_REMOTE_CONTROL                 = 'TRADFRI remote control';
    final public const ATTR_DEVICE_INFO_TYPE_DIMMER                         = 'TRADFRI dimmer';
    final public const ATTR_DEVICE_INFO_TYPE_DRIVER_10W                     = 'TRADFRI Driver 10W';
    final public const ATTR_DEVICE_INFO_TYPE_DRIVER_30W                     = 'TRADFRI Driver 30W';
    final public const ATTR_DEVICE_INFO_TYPE_BLUB                           = 'TRADFRI bulb';
    final public const ATTR_DEVICE_INFO_TYPE_BLUB_E27_WS                    = 'TRADFRI bulb E27 WS opal 980lm';
    final public const ATTR_DEVICE_INFO_TYPE_BLUB_E27_W                     = 'TRADFRI bulb E27 W opal 1000lm';
    final public const ATTR_DEVICE_INFO_TYPE_BLUB_E27_CWS_PAL_600_LM        = 'TRADFRI bulb E27 CWS opal 600lm';
    final public const ATTR_DEVICE_INFO_TYPE_BLUB_GU10_WS                   = 'TRADFRI bulb GU10 WS 400lm';
    final public const ATTR_DEVICE_INFO_TYPE_BLUB_GU10_W                    = 'TRADFRI bulb GU10 W 400lm';
    final public const ATTR_DEVICE_INFO_TYPE_BLUB_E14_W                     = 'TRADFRI bulb E14 W op/ch 400lm';
    final public const ATTR_DEVICE_INFO_TYPE_REPEATER                       = 'TRADFRI Signal Repeater';
    final public const ATTR_DEVICE_INFO_TYPE_FLOALT_30X90                   = 'FLOALT panel WS 30x90';
    final public const ATTR_DEVICE_INFO_TYPE_FLOALT_60X60                   = 'FLOALT panel WS 60x60';
    final public const ATTR_DEVICE_INFO_TYPE_FLOALT_30X30                   = 'FLOALT panel WS 30x30';
    final public const ATTR_DEVICE_INFO_TYPE_OPEN_CLOSE_REMOTE              = 'TRADFRI open/close remote';
    final public const ATTR_DEVICE_INFO_TYPE_ROLLER_BLIND                   = 'FYRTUR block-out roller blind';
}
