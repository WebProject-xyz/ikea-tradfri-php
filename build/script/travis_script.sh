...
if [[ $(phpenv version-name) == '7.2' ]]; then wget http://codeception.com/codecept.phar | chmod +x codecept.phar | mkdir -p vendor/bin/ | mv ./codecept.phar vendor/bin/codecept ; fi
